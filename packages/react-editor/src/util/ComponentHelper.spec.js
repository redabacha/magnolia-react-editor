...
import getComponentPropertiesJsonResult from '../../mock/expected-result/getComponentProperties.json';
...
describe('Test ComponentHelper', () => {
  ...
  it('getRenderedComponent', () => {
    ...
    // WHEN
    const pageComponent = ComponentHelper.getRenderedComponent(
      page,
      componentMapping
    );
    const nestedComponent = ComponentHelper.getRenderedComponent(
      nestedComponentContent,
      componentMapping
    );
  ...
  it('test classnames', () => {
    ...
    // WHEN
    const result = ComponentHelper.classnames(
      'class1',
      [{ class2: true, class3: false }, 'class4'],
      { class5: true }
    );
    // THEN
